...
String.prototype.toFormalCase = function() {return this.charAt(0).toUpperCase() + this.substr(1).toLowerCase();};
String.prototype.mkdRemoveRuler = function() {return this.split("\n").filter(l => l !== "---")};
