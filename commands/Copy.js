module.exports = {
    ...
    async execute(Libs, message, args) {
        ...
        if (!originChannel) throw new ConditionException(message, "Message Copy", "Origin channel not found. Confirm the channel with this ID exists and is visible to the bot client.");
        ...
        if (!archive) throw new ConditionException(message, "Message Copy", "Specified channel where the fetched message should be copied to was not found. Confirm the channel with this ID exists and is visible to the bot client.");
