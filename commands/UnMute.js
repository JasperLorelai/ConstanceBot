module.exports = {
    ...
    async execute(Libs, message, args) {
        ...
        if (!mutedRole) throw new ConditionException(message, "Mute", "Mute role was not initialised. This probably means nobody is muted.");
        if (!member.roles.cache.has(mutedRole.id)) throw new ConditionException(message, "Mute", "User is not muted.");
        ...
        message.reply(Util.embed("Mute", member.toString() + "'s mute status has been lifted by " + author.toString() + "."));
